...
// Lets a GeometricCamera* be saved and restored as the concrete type it
// really is. Replaces the register_type<>() calls Atlas used to make on the
// Boost archive, and keeps the tag stable and readable in the file.
SLAMCPP_REGISTER_POLYMORPHIC(ORB_SLAM3::GeometricCamera, ORB_SLAM3::KannalaBrandt8, "KannalaBrandt8")

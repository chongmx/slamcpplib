...
namespace ORB_SLAM3 {
    ...
    private:
         ...
         * Visual stuff
         */
        // Initialised, because they legitimately stay unset: a "Rectified"
        // stereo rig describes one camera, so the second pair is never built.
        // Left uninitialised, the settings printer dereferenced garbage and
        // took the process down before tracking ever started.
        GeometricCamera* calibration1_ = nullptr;
        GeometricCamera* calibration2_ = nullptr;   //Camera calibration

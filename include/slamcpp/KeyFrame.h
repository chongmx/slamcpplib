...
class KeyFrame
{
    ...
    void serialize(Archive& ar, const unsigned int version)
    {
        ...
        ar & slamcpp::serialization::make_array(mK_.data(), mK_.size());
        // Pose
        ...
        ar & mBackupNextKFId;
        ar & bImu;
        ar & slamcpp::serialization::make_array(mVw.data(), mVw.size());
        ar & slamcpp::serialization::make_array(mOwb.data(), mOwb.size());
        ar & mbHasVelocity;
    }

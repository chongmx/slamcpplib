...
protected:
    ...
    // Was GLubyte, which came from the pangolin header removed above;
    // GLubyte is an alias for unsigned char, so this is the same type
    // without the OpenGL dependency.
